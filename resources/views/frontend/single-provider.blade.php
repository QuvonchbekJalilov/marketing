                            ...
                            <div class="rate-reviews-small">
                                @for ($i = 0; $i < 5; $i++)
                                    ...
                                    <img src="{{ asset('/assets/imgs/template/icons/star.svg') }}" alt="jobhub"
                                         style="opacity: {{ $i < floor($average_score) ? '1' : '0.2' }};"/>
                                </span>
                                @endfor
                                <span
                                    class="ml-10 text-muted text-small">({{ number_format($average_score, 1) }})</span>
                            </div>
                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-6 mt-3">
                                    @foreach($services as $service)
                                        <a href="#"
                                           class="btn btn-tags-sm mb-10 mr-5">{{ $service->subCategory->name_uz ?? null }}</a>
                                    @endforeach
                        ...
                        <div class="links-box"
                            ...
                            <div class="link"
                                 style="border-right: 1px solid  #D1D3D4; padding:10px 28px; color: black;"><a
                                    href="#1"><i class="fa-regular fa-file" style="margin-right: 7px;"></i>About</a>
                            </div>
                            <div class="link"
                                 style="border-right: 1px solid  #D1D3D4; padding: 10px 28px; color: black;"><a
                            ...
                            <div class="link"
                                 style="border-right: 1px solid  #D1D3D4; padding: 10px 28px; color: black;"><a
                                    href="#awards"><i class="fa-solid fa-award"
                                                      style="margin-right: 7px;"></i>Awards</a></div>
                            <div class="link"
                                 style="border-right: 1px solid  #D1D3D4; padding: 10px 28px; color: black;"><a
                                    href="#reviews"><i class="fa-regular fa-star" style="margin-right: 7px;"></i>Reviews</a>
                            </div>
                            <div class="link" style="padding: 10px 28px;"><a href="#contact"><i
                    ...
                    <div class="col-lg-12">
                        ...
                        <section id="team" class="team-section">
                            ...
                            <section>
                                ...
                                <section id="reviews" class="reviews-section" style="margin: 30px 15px 0px !important;">
                                    ...
                                    <div
                                        ...
                                        <a href="{{route('singleReviews',$provider->id)}}">
                                            <button class="btn btn-brand-4-medium" type="submit">Write a review</button>
                                        </a>
                                ...
                                <section id="contact"
                                         class="contact-section section-box box-get-touch-section box-contact-form"

        ...
        <div class="offcanvas-header border-bottom" style="padding-top: 20px; padding-bottom: 20px">
            <div class="d-flex align-items-center">
                ...
                <a href="javascript:void(0);">
                    <h2 class="fs-14 fw-bold text-truncate-1-line">Add manager</h2>
                    ...
                    <div class="col-12">
                        <div id="taskDateRange">
                            ...
                            <div class="input-group date input-daterange">
                                <input type="text"  class="form-control" name="name" placeholder="Write Provider Name" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div id="taskDateRange">
                            ...
                            <div class="input-group date input-daterange">
                                <input type="text"  class="form-control" name="email" placeholder="Write Provider Email" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div id="taskDateRange">
                            ...
                            <div class="input-group date input-daterange">
                                <input type="password"  class="form-control" name="password" placeholder="Write Provider Email" autocomplete="off">
                            </div>
                        </div>
                    </div>
                </div>

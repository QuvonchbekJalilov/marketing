                ...
                <div class="d-flex align-items-center">
                            ...
                            <div class="search-items-wrapper">
                                ...
                                <div class="users-result px-4 py-2">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image rounded">
                                                <img src="/admin/assets/images/avatar/5.png" alt="" class="img-fluid">
                                            </div>
                                            <div>
                                ...
                                <div class="file-result px-4 py-2">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="/admin/assets/images/file-icons/css.png" alt="" class="img-fluid">
                                            </div>
                                            <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="/admin/assets/images/file-icons/zip.png" alt="" class="img-fluid">
                                            </div>
                                            <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="/admin/assets/images/file-icons/pdf.png" alt="" class="img-fluid">
                                            </div>
                                            <div>
                    ...
                    <div class="dropdown nxl-h-item nxl-header-language d-none d-sm-flex">
                        <a href="javascript:void(0);" class="nxl-head-link me-0 nxl-language-link" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                            <img src="/admin/assets/vendors/img/flags/4x3/us.svg" alt="" class="img-fluid wd-20">
                        </a>
                    ...
                    <div class="dropdown nxl-h-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-notifications-menu">
                            ...
                            <div class="notifications-item">
                                <img src="/admin/assets/images/avatar/3.png" alt="" class="rounded me-3 border">
                                <div class="notifications-desc">
                            ...
                            <div class="notifications-item">
                                <img src="/admin/assets/images/avatar/4.png" alt="" class="rounded me-3 border">
                                <div class="notifications-desc">
                    ...
                    <div class="dropdown nxl-h-item">
                        <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button" data-bs-auto-close="outside">
                            <img src="{{ asset('storage/'. $company->logo)}}" alt="user-image" class="img-fluid user-avtar me-0">
                        </a>
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('storage/'. $company->logo)}}" alt="user-image" class="img-fluid user-avtar">
                                    <div>
